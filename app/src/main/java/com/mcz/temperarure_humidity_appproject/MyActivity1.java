...
public class MyActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (ActivityCompat.checkSelfPermission(MyActivity1.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                    //如果没有权限

                    ActivityCompat.requestPermissions(MyActivity1.this, new String[]{Manifest.permission.CALL_PHONE},10111);//请求电话权限
                }
            }
        }).start();
...
//                获取到的accessToken
            ...
            Intent intent=new Intent(getApplication(), MyHistoryActivity.class);
            startActivity(intent);
            finish();
        }
    };
