package com.mcz.temperarure_humidity_appproject.Myview;
...
public class HealthView extends View{
    ...
    private double mAverageStep;//平均的步数
    private double mMaxStep;//最大的步数
    private double mTotalSteps;//总共的步数
    ...
    private void init() {
        ...
        mSteps=new double[]{10050,15280,8900,9200,6500,5660,9450};

        //-----------------自己写的-------------------------
        mtoptext="实时数据";
        bitmap= BitmapFactory.decodeResource(mContext.getResources(),R.drawable.avastar);
        danwei=" ";
        nowzhuangtai="当前状态正常";
        //--------------------------------------
        calculateSteps();
    ...
    public void settoptext(String toptext){
        mtoptext=toptext;
        Log.i("mtoptext",mtoptext);
    }
    public double getmAverageStep(){
        return mAverageStep;
    }

    public void setavastar(int avastar) {
        bitmap= BitmapFactory.decodeResource(mContext.getResources(),avastar);
    }
    ...
    public void setNowzhuangtai(String nowzhuangtai) {
        this.nowzhuangtai = nowzhuangtai;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mtoptext,xPos,yPos,mTextPaint);//最上面的文字
        mTextPaint.setTextAlign(Paint.Align.CENTER);
        ...
        canvas.drawText(danwei,mArcCenterX,yPos,mTextPaint);
        ...
        canvas.drawText("最近数据",xPos,yPos,mTextPaint);
        xPos=(int)((450.f-25.f)/450.f*mWidth);
        yPos=(int)(330.f/525.f*mHeight);
        mTextPaint.setTextAlign(Paint.Align.RIGHT);
        mTextPaint.setColor(Color.parseColor("#C1C1C1"));
        mTextPaint.setTextSize(12.f/450.f*mWidth);
        canvas.drawText("平均"+mAverageStep+danwei,xPos,yPos,mTextPaint);
        ...
        for (int i = 0; i <mSteps.length; i++) {
            float barHeight= (float) (mSteps[i]*1.f/mAverageStep*35.f/525.f*mHeight);
...
//            canvas.drawText("0"+(i+1)+"日",startX,startY+25.f/525.f*mHeight,mTextPaint);
        ...
        mTextPaint.setTextAlign(Paint.Align.LEFT);
        canvas.drawText(nowzhuangtai,xPos,yPos,mTextPaint);
