...
public class DataInfo implements Serializable{
    ...
    private String Devicewendu;
    private String Deviceshidu;
    ...
    public void setDevicewendu(String devicewendu) {
        Devicewendu = devicewendu;
    }

    public String getDevicewendu() {
        return Devicewendu;
    }

    public void setDeviceshidu(String deviceshidu) {
        Deviceshidu = deviceshidu;
    }

    public String getDeviceshidu() {
        return Deviceshidu;
    }
